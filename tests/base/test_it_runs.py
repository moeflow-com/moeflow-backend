...
def test_it_runs():
    ...
    app_logging.logger.error('global logger %d / %d', app_logging.logger.level, app_logging.logger.getEffectiveLevel())
    root_logger = logging.getLogger('root')
    logging.error("root logger %d / %d", root_logger.level, root_logger.getEffectiveLevel())
    create_app()
