...
class TestTestUtilsCase(MoeTestCase):
    ...
    def test_create_team(self):
        ...
        self.assertEqual(User.objects.count(), DEFAULT_USERS_COUNT + 1)
        # 测试名称
        team = Team.objects.skip(DEFAULT_TEAMS_COUNT).first()
    ...
    def test_create_project_set(self):
        ...
        # 测试数量
        self.assertEqual(ProjectSet.objects.count(), DEFAULT_PROJECT_SETS_COUNT + 2)
        self.assertEqual(Team.objects.count(), DEFAULT_TEAMS_COUNT + 1)
        self.assertEqual(User.objects.count(), DEFAULT_USERS_COUNT + 1)
        # 测试名称
    ...
    def test_create_project(self):
        ...
        self.assertIsNotNone(
            User.get_by_email("project-project_set-team-creator@test.com")
        )
    ...
    def test_create_file(self):
        with self.app.test_request_context():
            ...
            self.assertIsNotNone(
                User.get_by_email("file.txt-project-project_set-team-creator@test.com")
            )
